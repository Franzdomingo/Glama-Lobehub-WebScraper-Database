-- Glama.ai MCP Server - ANSI SQL Schema
...
CREATE TABLE mcp_server_categories (
    ...
    CONSTRAINT fk_server_category_server FOREIGN KEY (mcp_server_id) REFERENCES mcp_servers(id) ON DELETE CASCADE,
    CONSTRAINT fk_server_category_category FOREIGN KEY (category_id) REFERENCES mcp_categories(id) ON DELETE CASCADE
);
